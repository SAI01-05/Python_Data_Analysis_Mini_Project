...
A beginner-level exploratory data analysis (EDA) mini project built while learning Python for Data Analytics. The dataset contains Apple iPhone product listings from Flipkart India, analyzed using core Python libraries.

The project is structured around the **Data Analytics Life Cycle**:

```
Objective  →  Understanding the Data  →  Data Cleaning & Transformation
→  Data Enhancement  →  Data Analytics  →  Data Visualization
```
...
- Identify which iPhones have the highest star ratings on Flipkart
- Analyze the relationship between sale price and number of ratings
- Examine how discount percentage correlates with customer ratings
- Compare review and rating counts across top-rated iPhone models
